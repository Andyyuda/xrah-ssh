...
Name=$(curl -sS https://raw.githubusercontent.com/Andyyuda/xray-ssh/main/permission/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/Andyyuda/xray-ssh/main/permission/ip | grep $MYIP | awk '{print $3}')
